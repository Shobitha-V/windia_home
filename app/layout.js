...
// /* ============================================================
//    LAYOUT — root component used by Next.js app router
//    ============================================================ */
...
//   const waPhone   = '919686153413'
//   const waMessage = 'Hi! I have a question about WIN-DIA Thins.'
...
//             </div>
//             <span className="ann-dot" aria-hidden="true" />
//             <nav className="ann-pips" aria-label="Announcement navigation">
//               {annMessages.map((_, i) => (
//                 <button
//                   key={i}
...
//                 stroke="rgba(196,151,107,0.6)" strokeWidth="2">
...
//               <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
//                 stroke="rgba(196,151,107,0.6)" strokeWidth="1.5">
//                 <circle cx="11" cy="11" r="8"/>
//                 <line x1="21" y1="21" x2="16.65" y2="16.65"/>
//               </svg>
//               <input
